...
#include "cJSON.h"
#include "oled.h"
#define PROID		"1be3bc8bb35efd2491175174a008ea37"//设备id

#define AUTH_INFO	"chen2694"//密码
...
//					case 0:UsartPrintf(USART_DEBUG, "Tips:	连接成功\r\n");status = 0;break;
					case 0:	OLED_ShowString(0,0,"Tips:OK",16,1);status = 0;break;
//					case 1:UsartPrintf(USART_DEBUG, "WARN:	连接失败：协议错误\r\n");break;
					case 1:OLED_ShowString(0,0,"ERROR1",16,1);break;
//					case 2:UsartPrintf(USART_DEBUG, "WARN:	连接失败：非法的clientid\r\n");break;
					case 2:OLED_ShowString(0,0,"ERROR2",16,1);break;
//					case 3:UsartPrintf(USART_DEBUG, "WARN:	连接失败：服务器失败\r\n");break;
					case 3:OLED_ShowString(0,0,"ERROR3",16,1);break;
//					case 4:UsartPrintf(USART_DEBUG, "WARN:	连接失败：用户名或密码错误\r\n");break;
					case 4:OLED_ShowString(0,0,"ERROR4",16,1);break;
//					case 5:UsartPrintf(USART_DEBUG, "WARN:	连接失败：非法链接(比如token非法)\r\n");break;
					case 5:OLED_ShowString(0,0,"ERROR5",16,1);break;
//					default:UsartPrintf(USART_DEBUG, "ERR:	连接失败：未知错误\r\n");break;
					default:OLED_ShowString(0,0,"ERROR6",16,1);break;
				}
			}
		}
		...
		OLED_ShowString(0,0,"ERROR",16,1);
