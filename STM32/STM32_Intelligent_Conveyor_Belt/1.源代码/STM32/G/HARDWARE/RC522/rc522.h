...
*8--VCC <----->VCC
*/
#define RC522_OUTPUT_SET		 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_SET)
#define RC522_OUTPUT_RESET	 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_6,GPIO_PIN_RESET)

#define RC522_INPUT HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_7)

#define RC522_SCLK_SET 			HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5,GPIO_PIN_SET)
#define RC522_SCLK_RESET	 	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5,GPIO_PIN_RESET)

#define RC522_CS_SET			 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_4,GPIO_PIN_SET)
#define RC522_CS_RESET		 HAL_GPIO_WritePin(GPIOB,GPIO_PIN_4,GPIO_PIN_RESET)

#define RC522_RST_SET 		HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,GPIO_PIN_SET)
#define RC522_RST_RESET 	HAL_GPIO_WritePin(GPIOB,GPIO_PIN_9,GPIO_PIN_RESET)
