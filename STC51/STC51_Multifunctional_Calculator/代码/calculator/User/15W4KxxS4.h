...
#define PWM2T1H     (*(unsigned char volatile xdata *)0xFF00)   // PWM2T1计数高字节 
#define PWM2T1L     (*(unsigned char volatile xdata *)0xFF01)   // PWM2T1计数低字节 
#define PWM2T2      (*(unsigned int volatile xdata *)0xFF02)   
#define PWM2T2H     (*(unsigned char volatile xdata *)0xFF02)   // PWM2T2计数高字节 
#define PWM2T2L     (*(unsigned char volatile xdata *)0xFF03)   // PWM2T2计数低字节 
#define PWM2CR      (*(unsigned char volatile xdata *)0xFF04)   // PWM2控制         

#define PWM3T1      (*(unsigned int volatile xdata *)0xFF10)   
#define PWM3T1H     (*(unsigned char volatile xdata *)0xFF10)   // PWM3T1计数高字节 
#define PWM3T1L     (*(unsigned char volatile xdata *)0xFF11)   // PWM3T1计数低字节 
#define PWM3T2      (*(unsigned int volatile xdata *)0xFF12)
#define PWM3T2H     (*(unsigned char volatile xdata *)0xFF12)   // PWM3T2计数高字节 
#define PWM3T2L     (*(unsigned char volatile xdata *)0xFF13)   // PWM3T2计数低字节 
#define PWM3CR      (*(unsigned char volatile xdata *)0xFF14)   // PWM3控制         

#define PWM4T1      (*(unsigned int volatile xdata *)0xFF20)
#define PWM4T1H     (*(unsigned char volatile xdata *)0xFF20)   // PWM4T1计数高字节 
#define PWM4T1L     (*(unsigned char volatile xdata *)0xFF21)   // PWM4T1计数低字节 
#define PWM4T2      (*(unsigned int volatile xdata *)0xFF22)
#define PWM4T2H     (*(unsigned char volatile xdata *)0xFF22)   // PWM4T2计数高字节 
#define PWM4T2L     (*(unsigned char volatile xdata *)0xFF23)   // PWM4T2计数低字节 
#define PWM4CR      (*(unsigned char volatile xdata *)0xFF24)   // PWM4控制         

#define PWM5T1      (*(unsigned int volatile xdata *) 0xFF30)
#define PWM5T1H     (*(unsigned char volatile xdata *)0xFF30)   // PWM5T1计数高字节 
#define PWM5T1L     (*(unsigned char volatile xdata *)0xFF31)   // PWM5T1计数低字节 
#define PWM5T2      (*(unsigned int volatile xdata *)0xFF32)
#define PWM5T2H     (*(unsigned char volatile xdata *)0xFF32)   // PWM5T2计数高字节 
#define PWM5T2L     (*(unsigned char volatile xdata *)0xFF33)   // PWM5T2计数低字节 
#define PWM5CR      (*(unsigned char volatile xdata *)0xFF34)   // PWM5控制         

#define PWM6T1      (*(unsigned int volatile xdata *)0xFF40)
#define PWM6T1H     (*(unsigned char volatile xdata *)0xFF40)   // PWM6T1计数高字节 
#define PWM6T1L     (*(unsigned char volatile xdata *)0xFF41)   // PWM6T1计数低字节 
#define PWM6T2      (*(unsigned int volatile xdata *)0xFF42)
#define PWM6T2H     (*(unsigned char volatile xdata *)0xFF42)   // PWM6T2计数高字节 
#define PWM6T2L     (*(unsigned char volatile xdata *)0xFF43)   // PWM6T2计数低字节 
#define PWM6CR      (*(unsigned char volatile xdata *)0xFF44)   // PWM6控制         

#define PWM7T1      (*(unsigned int volatile xdata *)0xFF50)     
#define PWM7T1H     (*(unsigned char volatile xdata *)0xFF50)   // PWM7T1计数高字节     
#define PWM7T1L     (*(unsigned char volatile xdata *)0xFF51)   // PWM7T1计数低字节 
#define PWM7T2      (*(unsigned int volatile xdata *)0xFF52)
#define PWM7T2H     (*(unsigned char volatile xdata *)0xFF52)   // PWM7T2计数高字节 
#define PWM7T2L     (*(unsigned char volatile xdata *)0xFF53)   // PWM7T2计数低字节 
#define PWM7CR      (*(unsigned char volatile xdata *)0xFF54)   // PWM7控制         
